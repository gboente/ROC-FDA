...
##########################################
## Datos de A cardiotoxicity dataset for breas cancer patients
...
############################################################
#
#  Llamo a la funcion que calcula todas las ROC
#
############################################################

varianza.exp<-0.95 #porcentaje explicado
