...
VARIAS.ROC<- function(XD , XH, pe=seq(0,1,length=101), varianza.exp, grilla.tes,  base="PC", pooled="SI"){
	...
	####################################################### 
	# Curva ROC empírica y AUC basadas en el maximo 
	# sobre t de la curva de cada individuo
	#######################################################
	...
	#########################################################
	# la grilla es p=seq(0,1,length=101)
	# por lo tanto roc.max[1]==0
	#########################################################
	...
	####################################################### 
	# Curva ROC empírica y AUC basadas en el minimo 
	# sobre t de la curva de cada individuo
	#######################################################
	...
	####################################################### 
	# Curva ROC empírica y AUC basadas en el valor medio 
	# sobre t de la curva de cada individuo
	# o sea, tomando como direccion el beta(t)=1
	#######################################################
	...
	##################################################
	# BASADA EN LA DIFERENCIA DE LAS MEDIANAS
 	#################################################
	...
	#########################################################
	# la grilla es p=seq(0,1,length=101)
	# por lo tanto roc.dif.mediana[1]==0
	#########################################################

	roc.dif.mediana[1]= 0
 
	#################################
	# BASADA EN LA DIFERENCIA DE MEDIAS
	#################################
	...
	#########################################################
	# la grilla es p=seq(0,1,length=101)
	# por lo tanto roc.dif.medias[1]==0
	#########################################################
	...
	#################################################################
	# USO CPC  con % de varianza varrianza.exp
	################################################################
